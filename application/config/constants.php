...
/* custom variable */
define('developer','RCrizt');
define('system_name', 'CRM');
define('company_name', 'ABC Company');
define('company_email', 'test@test.com');
define('cc_email', 'test@test.com');
define('bcc_email', 'test@test.com');
