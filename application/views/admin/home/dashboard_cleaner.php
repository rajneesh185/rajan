...
<div class="row top_tiles">
  <?php if(1){
    ...
    $days10 = date('Y-m-d', strtotime('-10 days'));
    $count_no_invoice=0;
    $finish_last7days = 0;
...
<?php }?>
  ...
  <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
    ...
    <div class="tile-stats">
      ...
      <h3>Status</h3>
      <p>Job Incomplete after 10 days.</p>
    </div>
    </a>
  </div>
</div> 
            ...
            <tr>
              <td>  
                ...
                <div class="btn-group  btn-group-xs"id="tr<?php echo $rs->id;?>">
                  ...
                  <a href="<?php echo base_url();?>home/raise_an_issue_content/<?php echo en($rs->id,$key);?>" data-toggle="modal" data-target=".bs-example-modal-lg" class="btn btn-danger load_modal_details" type="button" data-placement="bottom" title="raised an issue"><i class="fa fa-pencil-square-o"></i></a>
                  <?php }?>
