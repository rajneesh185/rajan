...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Raise Issue <small>forms</small></h2>
      ...
      <div class="x_content">
        <br />
        <form method="post" id="frm_validation" action="<?php echo base_url();?>home/save_raised_issue/<?php echo en($id,$this->config->item('openssl_key'));?>" data-toggle="validator" class="form-horizontal form-label-left" enctype="multipart/form-data">

           

          <div class="form-group">
            <!--
            <label class="control-label col-md-3ad col-sm-3 col-xs-12" for="last-name">Responsible for the Issue  
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <select name="responsible" id="responsible" required="required" class="js-example-basic-single form-control col-md-7 col-xs-12">
               ...
               if($system_users){
                 foreach($system_users as $rs){ if(strtolower($arr_user_category[$rs->user_category]) != 'admin'){?>
