<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        <br />
        <form method="post" id="frm_validation" action="<?php echo base_url();?>maintenance/add_new_table_data/<?php echo $table_name;?>" data-toggle="validator" class="form-horizontal form-label-left">
          ...
          <textarea name="ds" id="description" style="display:none;" required="required"></textarea>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12"> 
              <select name="wash_approved" id="wash_approved" required="required" class="form-control col-md-7 col-xs-12">
                <option value="">select wash approved</option> 
          ...
          <div class="form-group">
            <label class="control-label col-12" for="last-name">Retail Price
              ...
              <input type="text" id="retail_price" name="retail_price" required="required" class="form-control col-md-7 col-xs-12">
        
          </div>
          <div class="form-group">
            <label class="control-label col-12" for="last-name">Liter Per Bottle
            </label> 
              <input type="text" id="liter_per_bottle" name="liter_per_bottle" required="required" class="form-control col-md-7 col-xs-12">
        
          </div>
          <div class="form-group">
            <label class="control-label col-12" for="last-name">Bottles Per Pallet
            </label> 
              <input type="text" id="bottles_per_pallet" name="bottles_per_pallet" required="required" class="form-control col-md-7 col-xs-12">
          ...
          <div class="form-group">
            <label class="control-label col-12" for="last-name">Ratio Ltrs of chemical required Per 1000 Bricks 
              ...
              <input type="number" id="chemicals_ratio" name="chemicals_ratio" required="required" value="" class="form-control col-md-7 col-xs-12">
