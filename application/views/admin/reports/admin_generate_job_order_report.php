...
<table class="table table-striped table-bordered table-hover ">
          ...
          ?>
            <tr>
              ...
              <td><?php if(strtolower($this->session->user_category) == 'manufacturer'){  echo $arr_usser_un[$rs->bricklayer]; }else{ echo $arr_usser[$rs->bricklayer]; }?>
              </td>   
              <td><?php if(strtolower($this->session->user_category) == 'manufacturer'){ echo $arr_usser_un[$rs->cleaner]; }else{ echo $arr_usser[$rs->cleaner]; }?>
              </td>  
              ...
              <td><?php if(isset($arr_comment_score['manufacturer'.$rs->id]) && $arr_comment_score['manufacturer'.$rs->id]){ 
                echo ($arr_comment_score['manufacturer'.$rs->id]/($arr_comment_score_count['manufacturer'.$rs->id] * 100)*100) ;
              }?></td>
              -->
