 <div class="row">
  <div class="col-md-6 col-sm-8 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Report <small>Cleaner Score Report</small></h2>
      ...
      <div class="x_content">
      <form method="post" id="frm_gen_report" name="frm_gen_report" target="_blank" action="<?php echo base_url();?>reports/generate_cleaner_score_report" data-toggle="validator" class="form-horizontal form-label-left" enctype="multipart/form-data">
              ...
              <?php 
               ...
               if($system_users){
                 foreach($system_users as $rs){ 
                  if(strtolower($arr_user_category[$rs->user_category]) == 'admin'){?>
        ...
        <?php if(strtolower($this->session->user_category) != 'cleaner'){?>
          ...
          <select id="cleaner" name="cleaner" class="form-control" >  
              ...
              <?php 
               ...
               <?php if(strtolower($this->session->user_category) == 'manufacturer' || strtolower($this->session->user_category) == 'builder'){?>   
               <option value="<?php echo $rs->id;?>"><?php echo $rs->un;?></option>
             <?php }else{?>
              <option value="<?php echo $rs->id;?>"><?php echo $rs->name;?></option>
             <?php }?>
